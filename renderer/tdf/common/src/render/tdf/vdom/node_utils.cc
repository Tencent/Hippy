...
void ParseBorderInfo(tdfcore::View& view, const DomStyleMap& style_map) {
  ...
  //  assert(style_map.find(view::kBorderTopLeftRadius) == style_map.end());
  //  assert(style_map.find(view::kBorderTopRightRadius) == style_map.end());
  //  assert(style_map.find(view::kBorderBottomLeftRadius) == style_map.end());
  //  assert(style_map.find(view::kBorderBottomRightRadius) == style_map.end());
}
