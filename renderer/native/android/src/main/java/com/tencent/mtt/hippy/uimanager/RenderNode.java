...
public class RenderNode {
    ...
    public RenderNode(int mId, HippyMap mPropsToUpdate, String className, ViewGroup rootView,
            ...
            if (mMoveHolders != null) {
                for (MoveHolder moveHolder : mMoveHolders) {
                    ...
                    for (int j = 0; j < moveHolder.mMoveIds.size(); j++) {
                        ...
                        mComponentManager.move(moveId.getId(), moveHolder.mMove2Id,
                                moveId.indexFromParent());
                    }
                }
                mMoveHolders = null;
            }
    ...
    public void updateEventListener(@NonNull HashMap<String, Object> props) {
        ...
        for (Entry<String, Object> entry : props.entrySet()) {
            ...
            mPropsToUpdate.pushBoolean(key, (Boolean) value);
        }
    }
