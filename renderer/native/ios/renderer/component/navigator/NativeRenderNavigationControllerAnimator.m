...
@interface NativeRenderNavigationControllerAnimator ()
...
@implementation NativeRenderNavigationControllerAnimator
...
+ (NSObject<UIViewControllerAnimatedTransitioning> *)animatorWithAction:(UINavigationControllerOperation)action
    ...
    NativeRenderNavigationControllerAnimator *animator = [NativeRenderNavigationControllerAnimator new];
