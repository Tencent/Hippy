...
@interface NativeRenderNavigatorHostView () {
    NSDictionary *_initProps;
    NSString *_appName;
    NativeRenderNavigatorRootViewController *_navigatorRootViewController;
    BOOL _isPresented;
}
@property (nonatomic, assign) NativeRenderNavigatorDirection nowDirection;
@end

@implementation NativeRenderNavigatorHostView
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    return [NativeRenderNavigationControllerAnimator animatorWithAction:operation diretion:self.nowDirection];
}
