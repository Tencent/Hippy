 ...
 */
typedef NS_ENUM(NSUInteger, NativeRenderCollectionViewWaterfallLayoutItemRenderDirection) {
...
extern NSString *const NativeRenderCollectionElementKindSectionFooter;

#pragma mark - NativeRenderCollectionViewDelegateWaterfallLayout

@class NativeRenderCollectionViewWaterfallLayout;

/**
 *  The NativeRenderCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  NativeRenderCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol NativeRenderCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - NativeRenderCollectionViewWaterfallLayout

/**
 *  The NativeRenderCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `NativeRenderCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note NativeRenderCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface NativeRenderCollectionViewWaterfallLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (NativeRenderCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight),
 * right to left (NativeRenderCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first
 * (NativeRenderCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: NativeRenderCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) NativeRenderCollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
