...
def build_android(args):
    ...
    for arch in _BUILD_ARCCHES:
        ...
        if use_ninja:
            check_result(os.system(f'ninja'))
        else:
            check_result(os.system(f'cmake --build .'))
