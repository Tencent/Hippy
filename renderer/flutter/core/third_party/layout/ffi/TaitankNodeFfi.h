...
#ifndef ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODEFFI_H_
#define ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODEFFI_H_
...
class TaitankNodeFfi : public FlexNode {
 public:
  TaitankNodeRef taitank_node_;
  TaitankNodeFfi();
  void FlexNodeReset();
...
#endif //ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODEFFI_H_
