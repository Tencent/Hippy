...
#ifndef ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODESTYLEFFI_H_
#define ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODESTYLEFFI_H_

#include "FlexStyle.h"
#include "TaitankNodeFfi.h"

class TaitankNodeStyleFfi : public FlexStyle {
 public:
  TaitankNodeStyleFfi();
 ...
 private:
  ~TaitankNodeStyleFfi();
  TaitankNodeFfi *flex_node_{};
};

#endif //ANDROID_NATIVE_LAYOUT_FFI_TAITANKNODESTYLEFFI_H_
