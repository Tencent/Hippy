...
typedef void (*post_code_cache_runnable)(int32_t engine_id, const char* code_cache_dir_char, int64_t runnable_id,
...
typedef void (*check_code_cache_sanity)(int32_t engine_id, const char* script_md5);
