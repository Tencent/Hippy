...
EXTERN_C int64_t InitJSFrameworkFFI(const char16_t* global_config, int32_t single_thread_mode,
                                    int32_t bridge_param_json, int32_t is_dev_module, int64_t group_id, int32_t engine_id,
                                    int32_t callback_id);

EXTERN_C int32_t RunScriptFromFileFFI(int32_t engine_id, const char16_t* file_path, const char16_t*
                                                                                                 script_name,
...
EXTERN_C void RunNativeRunnableFFI(int32_t engine_id, int32_t root_id, const char16_t* code_cache_path, int64_t runnable_id,
                                   int32_t callback_id);
