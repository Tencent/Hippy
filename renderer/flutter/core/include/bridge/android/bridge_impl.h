...
class BridgeImpl {
 ...
 public:
  static int64_t InitJsFrameWork(const std::shared_ptr<PlatformRuntime> &platform_runtime,
  ...
  static bool RunScriptFromAssets(int64_t runtime_id,
                                  bool can_use_code_cache,
  ...
  static void Destroy(int64_t runtime_id,
                      bool single_thread_mode,
                      std::function<void(int64_t)> callback);
