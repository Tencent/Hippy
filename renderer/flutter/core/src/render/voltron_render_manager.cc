...
void VoltronRenderManager::DispatchFunction(int32_t id,
...
void VoltronRenderManager::AddTouchEventListener(int32_t id,
                                                 std::shared_ptr<TouchEvent> event,
                                                 OnTouchEventListener listener) {

}

void VoltronRenderManager::RemoveTouchEventListener(std::shared_ptr<TouchEvent> event) {
