...
class VoltronBridgeManager implements Destroyable {
  ...
  Future<dynamic> callNativeFunction(int rootId, String callbackId, Object params) async {
    VoltronApi.callNativeFunction(_engineId, rootId, callbackId, params, true);
  }
  ...
  Future<dynamic> execNativeCallback(int rootId, String callbackId, Object params) async {
