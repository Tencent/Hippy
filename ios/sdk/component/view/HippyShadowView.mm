       ...
       absolutePosition:(CGPoint)absolutePosition
{
  ...
  CGRect frame = {{
    ...
    HippyRoundPixelValue(absoluteBottomRight.x - absoluteTopLeft.x),
    HippyRoundPixelValue(absoluteBottomRight.y - absoluteTopLeft.y)
  }};
...
- (NSString *)description
{
  ...
  description = [[description substringToIndex:description.length - 1] stringByAppendingFormat:@"; viewName: %@; hippyTag: %@; frame: %@>", self.viewName, self.hippyTag, NSStringFromCGRect(self.frame)];
  return description;
}
