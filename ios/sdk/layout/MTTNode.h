...
typedef MTTSize (* MTTMeasureFunc)(MTTNodeRef node, float width, MeasureMode widthMeasureMode,
...
protected:
    ...
    void cacheLayoutOrMeasureResult(MTTSize availableSize,MTTSizeMode measureMode,
