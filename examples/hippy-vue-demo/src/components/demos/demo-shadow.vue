...
<style scoped>
   ...
   *
   * boxShadow consists attrs as follow：box-shadow-opacity，box-shadow-radius，box-shadow-color，
   * box-shadow-offset, box-shadow-offset-x，box-shadow-offset-y，box-shadow-spread(iOS only)
   *
   ...
   * 如果设置了border-radius，在Android上必须同时在容器和内容同时设置该属性
   */
