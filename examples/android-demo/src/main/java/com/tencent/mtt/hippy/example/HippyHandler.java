...
*/
  ...
  private void create(
    ...
    if (!TextUtils.isEmpty(assetsFileName)) {
      initParams.coreJSAssetsPath = "vendor.android.js"; // "index.android.js";
    } else if (!TextUtils.isEmpty(jsFilePath)) {
      initParams.coreJSFilePath = jsFilePath + "/vendor.android.js";
    }
            ...
            // else
            {
              ...
              */
              if (!TextUtils.isEmpty(assetsFileName)) {
                ...
                */
                loadParams.jsFilePath = jsFilePath + "/index.android.js";
              }
