  ...
  try {
    ...
    return pages.flat().map(page => {
      ...
      return {
        ...
        devtoolsFrontendUrl: `http://localhost:${port}/front_end/inspector.html?experiments=true&ws=${encodeURIComponent(ws)}`,
        devtoolsFrontendUrlCompat: `http://localhost:${port}/front_end/inspector.html?experiments=true&ws=${encodeURIComponent(ws)}`,
...
const getAndroidTargets = ({host, port, wsPath, clientId}) => {
  ...
  return androidTargetManager.getTargets().map(({id: targetId, ws}) => {
    ...
    return {
      ...
      devtoolsFrontendUrl: `http://localhost:${port}/front_end/inspector.html?experiments=true&ws=${encodeURIComponent(wsUrl)}`,
      devtoolsFrontendUrlCompat: `http://localhost:${port}/front_end/inspector.html?experiments=true&ws=${encodeURIComponent(wsUrl)}`,
