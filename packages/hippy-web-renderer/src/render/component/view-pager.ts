import { BaseView, NodeProps, NodeTag, SCROLL_STATE } from '../../types';
...
export class ViewPager extends View<HTMLDivElement> {
  ...
  public constructor(id: number, pId: number) {
    super(id, pId);
    this.tagName = NodeTag.VIEW_PAGER;
...
class ViewPagerItem extends View<HTMLDivElement> {
  public constructor(id: number, pId: number) {
    super(id, pId);
    this.tagName = NodeTag.VIEW_PAGER_ITEM;
    this.dom = document.createElement('div');
  }
