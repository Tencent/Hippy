...
export const ORIGIN_TYPE = 'originType';
...
export const STYLE_RESIZE_MODE = 'resizeMode';
export const NODE_ID = 'id';
export const PROPS = 'props';
export const HIPPY_COMPONENT_METHOD = 'hippyComponentMethod';
export const EVENT_NODE_WILL_INSERT = 'cNodeWillInsert';
export const EVENT_NODE_WILL_REMOVE = ' cNodeWillRemove';
export const EVENT_CHILD_NODE_WILL_INSERT = 'cChildNodeWillInsert';
export const EVENT_CHILD_NODE_WILL_REMOVE = 'cChildNodeWillRemove';

export interface CElementConfig {
  create: (id: number, props: any) => void;
  propsFilter?: (props: any) => void;
}
export enum Modules {
  UI = 'UIManagerModule',
