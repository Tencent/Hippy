...
public interface FontAdapter {
   ...
   *
   * @param text the property of {@link TextVirtualNode}
   * @param fontSize the property of {@link TextVirtualNode}
   ...
   *
   * @param fontFamily the property of {@link TextVirtualNode}
