...
tdf::devtools::DomNodeMetas DomDevtoolsUtils::ToDomNodeMetas(std::shared_ptr<DomNode> dom_node) {
...
tdf::devtools::DomainMetas DomDevtoolsUtils::GetDomDomainData(std::shared_ptr<DomNode> dom_node, uint32_t depth,
...
tdf::devtools::DomNodeLocation DomDevtoolsUtils::GetNodeIdByDomLocation(std::shared_ptr<DomNode> dom_node, double x,
                                                                        double y) {
...
std::shared_ptr<DomNode> DomDevtoolsUtils::GetMaxDepthAndMinAreaHitNode(std::shared_ptr<DomNode> node, double x, double y) {
...
bool DomDevtoolsUtils::IsLocationHitNode(std::shared_ptr<DomNode> dom_node, double x, double y) {
...
std::shared_ptr<DomNode> DomDevtoolsUtils::GetSmallerAreaNode(std::shared_ptr<DomNode> old_node,
...
std::string DomDevtoolsUtils::ParseDomValue(const tdf::base::DomValue& dom_value) {
...
std::string DomDevtoolsUtils::ParseNodeProps(
