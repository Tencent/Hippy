...
/**
 * A serialization writer that write primitive value in their binary form. in little-endian order,
 * because Android is always little-endian order.
 */
...
public interface BinaryWriter {
  ...
  /**
   * Sets this writer's length. If new length is negative, it is treated as {@code current_length()
   * + new_length} If new length larger than writer capacity, the writer will be auto enlarge
   *
