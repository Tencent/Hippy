...
#include <future>
<<<<<<< HEAD:android/sdk/src/main/jni/com_tencent_mtt_hippy_bridge_HippyBridgeImpl.cc
...
>>>>>>> 7419592... feat(core): add dynamic load:android/sdk/src/main/jni/jni/com_tencent_mtt_hippy_bridge_HippyBridgeImpl.cc
