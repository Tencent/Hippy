...
struct SerializeXSONCallback {
  typedef void (*CallbackFunction)(Isolate* isolate,
                                   Local<Value> value,
                                   XSONValueType type,
                                   void* data);
  SerializeXSONCallback(CallbackFunction function = nullptr,
...
class V8_EXPORT XSON {
public:
  static void Stringify(Isolate* v8_isolate, Local<Object> xson_object,
                        SerializeXSONCallback callback =
                            SerializeXSONCallback());
};
...
class V8_EXPORT JSON {
 public:
  ...
  static MaybeLocal<Value> Parse(Isolate* isolate,
...
class V8_EXPORT Value : public Data {
  ...
  */
   ...
   */
  V8_HIDE bool IsBigIntObject() const;
   ...
   */
  V8_HIDE bool IsBigInt64Array() const;
   ...
   */
  V8_HIDE bool IsModuleNamespaceObject() const;

  V8_HIDE V8_WARN_UNUSED_RESULT MaybeLocal<BigInt> ToBigInt(
      Local<Context> context) const;
...
typedef void (*CodeCacheSanityCheckCallback)(Isolate*, int, Local<String>);
#endif
 ...
 */
class V8_INSPECTOR_EXPORT HeapStatistics {
 public:
  HeapStatistics();
...
class V8_INSPECTOR_EXPORT HeapSpaceStatistics {
 public:
  HeapSpaceStatistics();
...
class V8_INSPECTOR_EXPORT HeapObjectStatistics {
 public:
...
class V8_INSPECTOR_EXPORT HeapCodeStatistics {
 public:
  HeapCodeStatistics();
...
class V8_EXPORT EmbedderHeapTracer {
 public:
   ...
   * attached to.
   */
  V8_HIDE void IterateTracedGlobalHandles(TracedGlobalHandleVisitor* visitor);
   ...
   */
  V8_HIDE void GarbageCollectionForTesting(EmbedderStackState stack_state);
   ...
   */
  V8_HIDE void IncreaseAllocatedSize(size_t bytes);
  V8_HIDE void DecreaseAllocatedSize(size_t bytes);
...
class V8_EXPORT Isolate {
 public:
   ...
   */
  class V8_HIDE AllowJavascriptExecutionScope {
   public:
   ...
   */
  class V8_HIDE SuppressMicrotaskExecutionScope {
   public:
   ...
   */
  class V8_HIDE SafeForTerminationScope {
   public:
  ...
  V8_HIDE void SetAbortOnUncaughtExceptionCallback(
   ...
   */
  V8_HIDE void SetHostImportModuleDynamicallyCallback(
   ...
   */
  V8_HIDE void SetHostInitializeImportMetaObjectCallback(
   ...
   * is accessed.
   */
  V8_HIDE void SetPrepareStackTraceCallback(PrepareStackTraceCallback callback);
   ...
   */
  V8_HIDE void DumpAndResetStats();
   ...
   * to be Disposed.
   */
  V8_HIDE void DiscardThreadSpecificMetadata();

  /**
   * Associate embedder-specific data with the isolate. |slot| has to be
   * between 0 and GetNumberOfDataSlots() - 1.
   */
  V8_HIDE V8_INLINE void SetData(uint32_t slot, void* data);

  /**
   * Retrieve embedder-specific data from the isolate.
   * Returns NULL if SetData has never been called for the given |slot|.
   */
  V8_HIDE V8_INLINE void* GetData(uint32_t slot);

  /**
   * Returns the maximum number of available embedder data slots. Valid slots
   * are in the range of 0 - GetNumberOfDataSlots() - 1.
   */
  V8_HIDE V8_INLINE static uint32_t GetNumberOfDataSlots();
   ...
   */
  V8_HIDE void GetHeapStatistics(HeapStatistics* heap_statistics);


  /**
   * Returns the number of spaces in the heap.
   */
  V8_HIDE size_t NumberOfHeapSpaces();
   ...
   * \returns true on success.
   */
  V8_HIDE bool GetHeapSpaceStatistics(
        HeapSpaceStatistics* space_statistics, size_t index);

  /**
   * Returns the number of types of objects tracked in the heap at GC.
   */
  V8_HIDE size_t NumberOfTrackedHeapObjectTypes();
   ...
   * \returns true on success.
   */
  V8_HIDE bool GetHeapObjectStatisticsAtLastGC(HeapObjectStatistics* object_statistics,
                                       size_t type_index);
   ...
   * \returns true on success.
   */
  V8_HIDE bool GetHeapCodeAndMetadataStatistics(HeapCodeStatistics* object_statistics);
   ...
   */
  V8_HIDE void GetStackSample(const RegisterState& state, void** frames,
   ...
   */
  V8_HIDE size_t NumberOfPhantomHandleResetsSinceLastCall();

  /**
   * Returns heap profiler for this isolate. Will return NULL until the isolate
   * is initialized.
   */
  V8_HIDE HeapProfiler* GetHeapProfiler();

  /**
   * Tells the VM whether the embedder is idle or not.
   */
  V8_HIDE void SetIdle(bool is_idle);
   ...
   * returned.
   */
  V8_HIDE Local<Context> GetEnteredOrMicrotaskContext();
   ...
   */
  V8_HIDE Local<Context> GetIncumbentContext();
   ...
   */
  V8_HIDE void RemoveGCPrologueCallback(GCCallbackWithData, void* data = nullptr);
  V8_HIDE void RemoveGCPrologueCallback(GCCallback callback);
   ...
   * `Atomics.wait` call.
   */
  class V8_HIDE AtomicsWaitWakeHandle {
   public:
    /**
   ...
   */
  V8_HIDE void SetAtomicsWaitCallback(AtomicsWaitCallback callback, void* data);
   ...
   */
  V8_HIDE void RemoveGCEpilogueCallback(GCCallbackWithData callback,
                                void* data = nullptr);
  V8_HIDE void RemoveGCEpilogueCallback(GCCallback callback);
   ...
   */
  V8_HIDE void SetGetExternallyAllocatedMemoryInBytesCallback(
   ...
   * acquired the V8 lock with a Locker object.
   */
  V8_HIDE void CancelTerminateExecution();
   ...
   * schedule.
   */
  V8_HIDE void RequestGarbageCollectionForTesting(GarbageCollectionType type);

  /**
   * Set the callback to invoke for logging event.
   */
  V8_HIDE void SetEventLogger(LogEventCallback that);
   ...
   * further callbacks.
   */
  V8_HIDE void AddCallCompletedCallback(CallCompletedCallback callback);

  /**
   * Removes callback that was installed by AddCallCompletedCallback.
   */
  V8_HIDE void RemoveCallCompletedCallback(CallCompletedCallback callback);

  /**
   * Set the PromiseHook callback for various promise lifecycle
   * events.
   */
  V8_HIDE void SetPromiseHook(PromiseHook hook);
   ...
   */
  V8_HIDE MicrotasksPolicy GetMicrotasksPolicy() const;
  ...
  V8_HIDE void AddMicrotasksCompletedCallback(
  ...
  V8_DEPRECATE_SOON("Use *WithData version.",
                    void RemoveMicrotasksCompletedCallback(
                        MicrotasksCompletedCallback callback));
  V8_HIDE void RemoveMicrotasksCompletedCallback(
      MicrotasksCompletedCallbackWithData callback, void* data = nullptr);

  /**
   * Sets a callback for counting the number of times a feature of V8 is used.
   */
  V8_HIDE void SetUseCounterCallback(UseCounterCallback callback);

  /**
   * Enables the host application to provide a mechanism for recording
   * statistics counters.
   */
  V8_HIDE void SetCounterFunction(CounterLookupCallback);
   ...
   * function.
   */
  V8_HIDE void SetCreateHistogramFunction(CreateHistogramCallback);
  V8_HIDE void SetAddHistogramSampleFunction(AddHistogramSampleCallback);
   ...
   */
  V8_HIDE void EnableMemorySavingsMode();

  /**
   * Optional notification which will disable the memory savings mode.
   */
  V8_HIDE void DisableMemorySavingsMode();
   ...
   */
  V8_HIDE void IncreaseHeapLimitForDebugging();
   ...
   *     Isolate setup.
   */
  V8_HIDE void SetJitCodeEventHandler(JitCodeEventOptions options,
   ...
   */
  V8_HIDE void GetCodeRange(void** start, size_t* length_in_bytes);

  /**
   * Returns the UnwindState necessary for use with the Unwinder API.
   */
  V8_HIDE UnwindState GetUnwindState();
   ...
   * invoked.
   */
  V8_HIDE void AddNearHeapLimitCallback(NearHeapLimitCallback callback, void* data);
   ...
   */
  V8_HIDE void RemoveNearHeapLimitCallback(NearHeapLimitCallback callback,
                                   size_t heap_limit);
   ...
   */
  V8_HIDE void AutomaticallyRestoreInitialHeapLimit(double threshold_percent = 0.5);
  ...
  */
   ...
   */
  V8_HIDE void RemoveMessageListeners(MessageCallback that);
   ...
   */
  V8_HIDE void VisitExternalResources(ExternalResourceVisitor* visitor);
   ...
   */
  V8_HIDE void SetAllowAtomicsWait(bool allow);
   ...
   */
  V8_HIDE void LocaleConfigurationChangeNotification();
...
class V8_EXPORT V8 {
 public:
   ...
   */
  V8_HIDE static void SetFlagsFromCommandLine(int* argc,
                                      char** argv,
                                      bool remove_flags);

  /** Get the version string. */
  V8_HIDE static const char* GetVersion();
   ...
   */
  V8_HIDE static bool InitializeICU(const char* icu_data_file = nullptr);
   ...
   * default.
   */
  V8_HIDE static bool InitializeICUDefaultLocation(const char* exec_path,
   ...
   * initialized.
   */
  static void InitializePlatform(Platform* platform, bool main_thread=false);
  ...
  V8_DEPRECATE_SOON("Use TryHandleWebAssemblyTrapPosix",
                    V8_HIDE static bool TryHandleSignal(int signal_number, void* info,
                                                void* context));
#endif  // V8_OS_POSIX
   ...
   */
  V8_HIDE static bool EnableWebAssemblyTrapHandler(bool use_v8_signal_handler);
 ...
 private:
  ...
  V8_HIDE static internal::Address* GlobalizeTracedReference(internal::Isolate* isolate,
                                                     internal::Address* handle,
                                                     internal::Address* slot);
  static void MoveGlobalReference(internal::Address** from,
                                  internal::Address** to);
  V8_HIDE static void MoveTracedGlobalReference(internal::Address** from,
                                        internal::Address** to);
  ...
  V8_HIDE static void DisposeTracedGlobal(internal::Address* global_handle);
  static void MakeWeak(internal::Address* location, void* data,
                       WeakCallbackInfo<void>::Callback weak_callback,
                       WeakCallbackType type);
  static void MakeWeak(internal::Address** location_addr);
  static void RegisterExternallyReferencedObject(internal::Address* object,
...
class V8_EXPORT Context {
 public:
   ...
   */
  V8_HIDE static MaybeLocal<Object> NewRemoteContext(
  ...
  V8_HIDE Local<Value> GetSecurityToken();
