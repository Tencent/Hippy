    ...
    <div class="bg-white dark:bg-black rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 h-full w-[620px] max-w-full flex flex-col">
      ...
      >
        <template v-if="step === 0">
          <img
            src="~@vue-devtools/assets/devtools-logo.svg"
            alt="Devtools logo"
        ...
        <template v-if="step === 2">
          <img
            src="~@vue-devtools/assets/welcome/main-tabs.png"
            alt="Main tabs"
            class="max-h-[120px]"
          >
        ...
        <template v-if="step === 3">
          ...
          <img
            src="~@vue-devtools/assets/welcome/components.png"
        ...
        <template v-if="step === 4">
          ...
          <img
            src="~@vue-devtools/assets/welcome/components-menu.png"
            alt="Components menu"
            class="max-h-[270px]"
          >
        </template>
        ...
        <template v-if="step === 5">
          ...
          <img
            src="~@vue-devtools/assets/welcome/inspector-pinia2.png"
            alt="Pinia inspector"
          >
        </template>
        ...
        <template v-if="step === 6">
          ...
          <img
            src="~@vue-devtools/assets/welcome/timeline.png"
            alt="Timeline"
          >
        </template>
        ...
        <template v-if="step === 7">
          ...
          <img
            src="~@vue-devtools/assets/welcome/timeline-perf2.png"
            alt="Timeline"
          >
        </template>
        ...
        <template v-if="step === 8">
          ...
          <img
            src="~@vue-devtools/assets/welcome/timeline-pinia.png"
            alt="Timeline pinia"
          >
        </template>
        ...
        <template v-if="step === 9">
          ...
          <img
            src="~@vue-devtools/assets/welcome/app-selector.png"
            alt="App selector"
            class="max-h-[280px]"
          >
        </template>
