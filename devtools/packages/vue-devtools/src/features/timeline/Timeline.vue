<script lang="ts">
import SplitPane from '@vue-devtools/features/layout/SplitPane.vue'
...
import { onSharedDataChange } from '@vue-devtools/util/shared-data'
import { formatTime } from '@vue-devtools/util/format'
import { useFonts } from '@vue-devtools/util/fonts'
import {
  useTime,
  useLayers,
  resetTimeline,
