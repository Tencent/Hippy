<script lang="ts">
import PluginSourceIcon from '@vue-devtools/features/plugin/PluginSourceIcon.vue'
...
import { useRoute } from '@vue-devtools/util/router'
import { useBridge } from '@vue-devtools/features/bridge'
import { useInspectors } from '@vue-devtools/features/inspector/custom/composable'
...
<template>
  <div class="flex items-center space-x-2 px-2 h-8">
    ...
    <template v-if="showAppsSelector">
      ...
      <img src="~@vue-devtools/assets/breadcrumb-separator.svg">
    </template>
