...
const hippyVuePackage = require('../framework/hippy/packages/hippy-vue/package.json');
const cssLoaderPackage = require('../framework/hippy/packages/hippy-vue-css-loader/package.json');
const nativeComponentsPackage = require('../framework/hippy/packages/hippy-vue-native-components/package.json');
const routerPackage = require('../framework/hippy/packages/hippy-vue-router/package.json');
...
function resolvePackage(src, extra = 'src') {
  return path.resolve(__dirname, '../framework/hippy/packages/', src, extra);
}
...
const aliases = {
  ...
  sfc: resolveVue('sfc'),
  he: path.resolve(__dirname, '../framework/hippy/packages/hippy-vue/src/util/entity-decoder'),
