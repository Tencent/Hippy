...
- Vue.Native
  ...
  Another thing to note is that in @hippy/vue Native properties are capitalized, like Vue.Native.NetInfo, Vue.Native.Cookie, and so on. In @hippy/vue-next, they are all changed to camel case. Such as Native.netInfo, Native.cookie, etc.
