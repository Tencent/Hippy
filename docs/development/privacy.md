...
#### 3. Hippy SDK Harmony版

Harmony版SDK不会为实现SDK产品功能而收集个人信息。
...
| 权限名称 | 权限说明     | 权限使用目的            |
|------|----------|-------------------|
| ohos.permission.INTERNET | 连网权限 | 下载js和加载图片都需要连网 |
| ohos.permission.GET\_NETWORK\_INFO | 获取网络信息权限 | 判断网络类型是wifi或5g等需要 |
