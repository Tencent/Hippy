...
[[hippy-vue-next 介绍]](api/hippy-vue-next/introduction.md) [[范例工程]](//github.com/Tencent/Hippy/tree/master/examples/hippy-vue-next-demo)
...
| @hippy/vue-router-next-history       | hippy-vue-next 的路由历史处理，支持物理按键回退路由历史 |
...
>注意：@hippy/vue(即vue2.x版本将于年底停止更新，请用户尽快升级至@hippy/vue-next，即vue3.x版本)
