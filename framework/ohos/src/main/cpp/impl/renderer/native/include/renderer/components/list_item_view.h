...
public:
  ...
  bool ReuseArkUINode(std::shared_ptr<RecycleView> &recycleView, int32_t index) override;
  ...
  void StartSticky();
  void EndSticky();
  std::shared_ptr<StackNode> GetStickyRootArkUINode();
