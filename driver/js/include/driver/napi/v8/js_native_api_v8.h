...
class V8Ctx : public Ctx {
 public:
  ...
  v8::internal::Address GetValueAddr(const  v8::Local<v8::Value>& v);
 ...
 private:
  ...
  std::unordered_map<v8::internal::Address, std::pair<v8::Global<v8::Value>,  v8::Global<v8::Value>>> pending_unhandled_rejections_;
};
