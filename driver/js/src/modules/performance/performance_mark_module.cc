...
//          mark->GetName(), mark->GetSubType(), mark->GetType(), mark->GetStartTime(), mark->GetDuration());
      // auto call = context->GetProperty(performance_entry_class, context->CreateString("call"));
//      auto prototype = context->GetProperty(performance_entry_class, "prototype");
//      auto constructor = context->GetProperty(prototype, "constructor");
//      auto call = context->GetProperty(constructor, "call");
