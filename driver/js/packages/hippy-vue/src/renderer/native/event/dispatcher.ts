...
function isTouchEvent(eventName: any) {
 ...
 * convert events
 */
function convertEvent(eventName: any, targetEvent: any, params: any) {
...
const EventDispatcher = {
   ...
   */
  receiveNativeEvent(nativeEvent: any) {
   ...
   */
  receiveComponentEvent(nativeEvent: any, domEvent: any) {
