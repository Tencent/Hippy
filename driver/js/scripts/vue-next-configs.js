...
const builds = {
  '@hippy/hippy-vue-next-style-parser-cjs': {
    ...
    banner: banner('@hippy/hippy-vue-next-style-parser', hippyStyleParserPackage.version, bannerStrAndHippyVueString, 2023),
    external: ['@vue/shared'],
  },
  ...
  '@hippy/vue-next-cjs': {
    ...
    format: 'cjs',
    banner: banner('@hippy/vue-next', hippyVueNextPackage.version, bannerStrAndHippyVueString, 2023),
    name: 'hippy-vue-next',
  ...
  '@hippy/vue-next-server-renderer-cjs': {
    ...
    banner: banner('@hippy/vue-next-server-renderer', hippyServerRendererPackage.version, bannerStrAndHippyVueString, 2023),
  ...
  '@hippy/vue-next-compiler-ssr': {
    ...
    banner: banner('@hippy/vue-next-compiler-ssr', hippyCompilerSsrPackage.version, bannerStrAndHippyVueString, 2023),
